...
namespace Elendow.SpritedowAnimator
{
    public class SpriteAnimation : ScriptableObject
    {
        ...
        [SerializeField]
        private List<SpriteAnimationEvent> events = new List<SpriteAnimationEvent>();

        public float TimeDuration => (float)AnimationDuration / (float)FPS;
        ...
        public List<SpriteAnimationEvent> Events
        {
            get { return events; }
            set { events = value; }
        }
