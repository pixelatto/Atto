...
namespace Atto.Managers
{
	public class WindowsFileBrowserService : FileBrowserService
	{
		...
		public override void OpenFile(string dialogTitle, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
		...
		public override void OpenFile(string dialogTitle, string extensionsFilter, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} \"{1}\" {2} \"{3}\"",
		...
		public override void OpenFile(string dialogTitle, string extensionsFilter, string initialDirectory, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} \"{1}\" {2} \"{3}\" {4} \"{5}\"",
		...
		public override void OpenMultipleFiles(string dialogTitle, Action<FileBrowserResponseReason, string[]> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} \"{1}\" {2}",
		...
		public override void OpenMultipleFiles(string dialogTitle, string extensionsFilter, Action<FileBrowserResponseReason, string[]> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} \"{1}\" {2} \"{3}\" {4}",
		...
		public override void OpenMultipleFiles(string dialogTitle, string extensionsFilter, string initialDirectory, Action<FileBrowserResponseReason, string[]> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} \"{1}\" {2} \"{3}\" {4} {5} \"{6}\"",
		...
		public override void OpenFolder(string dialogDescription, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} {1} {2} \"{3}\"",
		...
		public override void SaveFile(string dialogTitle, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} {1} {2} \"{3}\"",
		...
		public override void SaveFile(string dialogTitle, string extensionsFilter, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} {1} {2} \"{3}\" {4} \"{5}\"",
		...
		public override void SaveFile(string dialogTitle, string extensionsFilter, string initialDirectory, Action<FileBrowserResponseReason, string> onBrowserResponse)
		{
			var arguments = string.Format
			(
				"{0} {1} {2} \"{3}\" {4} \"{5}\" {6} \"{7}\"",
