    ...
    public class BaseAnimator : MonoBehaviour
    {
        ...
        public void Initialize(bool playOnAwake, List<SpriteAnimation> animations, string startAnimation)
        {
            ...
            foreach (var animation in animations)
            {
                ...
                {
                    animationEvent.AddListener((x) => this.SendMessage(animationEvent.eventName));
                }
            }
        ...
        /// </returns>  
        //public SpriteAnimationEvent AddCustomEvent(int frame)
        //{
        ...
        /// </returns>  
        //public SpriteAnimationEvent AddCustomEvent(string animation, int frame)
        //{
        ...
        /// </returns>  
        //public SpriteAnimationEvent AddCustomEvent(SpriteAnimation animation, int frame)
        //{
        ...
        /// </returns>  
        //public SpriteAnimationEvent GetCustomEvent(int frame)
        //{
        //    if (animations.Count == 0)
        //        return null;
        ...
        /// </returns>  
        //public SpriteAnimationEvent GetCustomEvent(string animation, int frame)
        //{
        //    SpriteAnimation anim = GetAnimation(animation);
        ...
        /// The event of the specified animation on the selected frame. Null if not found.
        /// </returns>  
        //public SpriteAnimationEvent GetCustomEvent(SpriteAnimation animation, int frame)
        //{
        //    if (animation == null || animation.FramesCount <= frame)
        //    {
        //        return null;
        ...
        /// </returns> 
        //public SpriteAnimationEvent GetCustomEventAtEnd()
        //{
        //    if (animations.Count == 0)
        //        return null;
        ...
        /// </returns>  
        //public SpriteAnimationEvent GetCustomEventAtEnd(string animation)
        //{
        //    SpriteAnimation anim = GetAnimation(animation);
        ...
        /// The event of the specified animation on the last frame. Null if not found.
        /// </returns>  
        //public SpriteAnimationEvent GetCustomEventAtEnd(SpriteAnimation animation)
        //{
        //    if (animation == null)
        //        return null;
