...
public partial class Container
{
	...
	private object Get(Type type, Identifier id)
	{
		...
		if (instance == null && Application.isPlaying)
		{
			...
			{
				Debug.Log("Service " + type + " missing or not initialized, loading first scene.");

				if (!loadingFirstScene)
				{
					loadingFirstScene = true;
